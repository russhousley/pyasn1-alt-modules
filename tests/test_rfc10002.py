...
from pyasn1_alt_modules import rfc10002
...
"""
    ...
    def testDerCodec(self):
        ...
        getNextLayer = {
            ...
            rfc10002.id_cct_PKIData: lambda x: None
        }
    ...
    def testOpenTypes(self):
        ...
        self.assertEqual(rfc10002.id_cct_PKIData, eci['eContentType'])

        substrate = eci['eContent']
        asn1Object, rest = der_decoder(
            substrate, asn1Spec=rfc10002.PKIData(), openTypes=openTypeMap,
...
class HMACAlgorithmIdentifierMapTestCase(unittest.TestCase):

    def testHMACAlggorithmIdentifiersMap(self):
        algorithmIdentifierMap = opentypemap.get('algorithmIdentifierMap')
        digestAlgorithm = univ.ObjectIdentifier((1, 2, 840, 113549, 2))
        for i in range(8, 13+1):
            oid = digestAlgorithm + (i, )
