...
id_pad_null = univ.RelativeOID('0') # no padding algorithms identified

id_pad_1 = univ.RelativeOID('1')    # padding method 2 of ISO/IEC 9797-1:1999
...
class AriaPadAlgo(univ.Choice):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType('specifiedPadAlgo', univ.RelativeOID()),
